...
import { OptionStream } from '../../src/pipeline/option-stream';
...
describe('OptionStream', () => {
  describe('buildContractPool', () => {
    ...
    it('uses custom optionPrefix', () => {
      const pool = OptionStream.buildContractPool(570, 5, 1, ['2026-04-01'], 'XSP');
      // XSP: center 570, ±5 at interval 1 = 11 strikes × 2 = 22
      expect(pool).toHaveLength(22);
      expect(pool).toContain('XSP260401C00570000');
      expect(pool).toContain('XSP260401P00565000');
    });
